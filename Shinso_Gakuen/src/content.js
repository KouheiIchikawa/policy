export const policyCopy = {
  ja: {
    metaTitle: 'シンソウ学園 | プライバシーポリシー',
    brand: 'シンソウ学園',
    ariaBrand: 'シンソウ学園',
    eyebrow: 'Official App Policy',
    ...
    sections: [
      ...
      },
      {
        title: '第三者提供',
        body:
          '本アプリは、法令に基づく場合を除き、利用者の個人情報を第三者に提供しません。また、利用者を直接特定する情報の販売または貸与は行いません。',
      },
      {
        title: '外部サービス',
        body:
      ...
      },
      {
        title: 'お問い合わせ',
        body:
          '本プライバシーポリシーに関するお問い合わせは、公式Xアカウントよりお願いいたします。',
        contactLabel: '@sio_sio_bull',
      },
      {
        title: '改定',
        body:
          '本プライバシーポリシーは、必要に応じて改定されることがあります。重要な変更がある場合は、本ページ上で告知します。',
      },
    ],
    ...
    miniPolicy: 'PRIVACY',
    miniContact: 'CONTACT',
    footer: '© 2026 Shinso Gakuen. All Rights Reserved.',
  },
  en: {
    metaTitle: 'Shinso Gakuen | Privacy Policy',
    brand: 'Shinso Gakuen',
    ariaBrand: 'Shinso Gakuen',
    eyebrow: 'Official App Policy',
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "The App does not provide users' personal information to third parties except as required by law. The App also does not sell or rent information that directly identifies users.",
      },
      {
      ...
      },
      {
        title: 'Contact',
        body:
          'For inquiries about this Privacy Policy, please contact us through the official X account.',
        contactLabel: '@sio_sio_bull',
      },
      {
        title: 'Changes',
        body:
          'This Privacy Policy may be revised as necessary. Important changes will be announced on this page.',
      },
    ],
    asideTitle: 'SHINSO GAKUEN',
